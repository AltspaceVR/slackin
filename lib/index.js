...
export default function slackin ({
  ...
  app.get('/', (req, res) => {
    ...
    let page = dom('html',
      ...
      splash({ css, coc, path, name, org, logo, channels, active, total, gcaptcha_sitekey}),
      dom('p.banner',
        'Ask questions, get answers, show off your work!',
        dom(`img src=${path}assets/slack-preview.jpg`)
      ),
    )
    res.type('html')
    res.send('<!doctype html>' + page.toHTML())
  })
